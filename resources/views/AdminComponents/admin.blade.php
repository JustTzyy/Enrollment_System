...
@section('content')
  ...
  <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
    ...
    <form action="{{ route('AdminComponents.admin') }}" method="GET">
  ...
  <div class="table-responsive ">
    ...
    <tbody>
      ...
      <td>
        <button type="button" class="btn btn-outline-info btn-sm" data-bs-toggle="modal" data-bs-target="#userDetailsModal{{ $user->id }}">
          <i class="fas fa-eye me-1"></i> See More
        </button>
      </td>
      <td class="d-flex justify-content-center gap-2">
        <button class="btn btn-outline-primary btn-sm d-flex align-items-center" onclick="if(confirm('Are you sure you want to edit this user?')) { var myModal = new bootstrap.Modal(document.getElementById('editUserModal{{ $user->id }}')); myModal.show(); }">
          ...
          <div class="modal-content">
            <div class="modal-header bg-primary text-white">
              <h5 class="modal-title" id="userDetailsLabel{{ $user->id }}">
                <i class="fas fa-user-shield me-2"></i>Admin Details - {{ $user->getFullNameAttribute() }}
              </h5>
                ...
                <div class="card-body">
                  <ul class="nav nav-tabs mb-3" id="detailsTab{{ $user->id }}" role="tablist">
                    <li class="nav-item" role="presentation">
                      <button class="nav-link active" id="user-tab{{ $user->id }}" data-bs-toggle="tab" data-bs-target="#userDetails{{ $user->id }}" type="button" role="tab">
                        <i class="fas fa-user me-1"></i> User Info
                      </button>
                    </li>
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="address-tab{{ $user->id }}" data-bs-toggle="tab" data-bs-target="#addressDetails{{ $user->id }}" type="button" role="tab">
                  ...
                  <div class="tab-content">
                    <div class="tab-pane fade show active" id="userDetails{{ $user->id }}" role="tabpanel">
                      <div class="mb-3">
                        <h6 class="fw-bold mb-3 text-primary"><i class="fas fa-id-badge me-2"></i>Personal Information</h6>
                        <dl class="row mb-0">
                    ...
                    <div class="tab-pane fade" id="addressDetails{{ $user->id }}" role="tabpanel">
                      <div class="mb-3">
                        <h6 class="fw-bold mb-3 text-primary"><i class="fas fa-home me-2"></i>Address Information</h6>
                        <dl class="row mb-0">
  ...
  <div class="modal fade" id="addUserModal" tabindex="-1" aria-labelledby="addUserModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <form action="{{ route('AdminComponents.admin') }}" method="POST">
        @csrf
