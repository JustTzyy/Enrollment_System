...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mt-5 flex-wrap gap-3">
        ...
        <form action="{{ route('AdminComponents.studenthistory') }}" method="GET">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu">
                <li><a class="dropdown-item"
                        href="{{ route('AdminComponents.studenthistory', ['status' => 'Added'] + request()->query()) }}">Added</a>
                </li>
                <li><a class="dropdown-item"
                        href="{{ route('AdminComponents.studenthistory', ['status' => 'Updated'] + request()->query()) }}">Updated</a>
                </li>
                <li><a class="dropdown-item"
                        href="{{ route('AdminComponents.studenthistory', ['status' => 'Deleted'] + request()->query()) }}">Deleted</a>
                </li>
                <li><a class="dropdown-item"
                        href="{{ route('AdminComponents.studenthistory', ['status' => 'Restored'] + request()->query()) }}">Restored</a>
                </li>
            </ul>
        </div>
    </div>
