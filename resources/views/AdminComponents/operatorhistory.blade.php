        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu">
                <li><a class="dropdown-item"
                        href="{{ route('AdminComponents.operatorhistory', ['status' => 'Added'] + request()->query()) }}">Added</a>
                </li>
                <li><a class="dropdown-item"
                        href="{{ route('AdminComponents.operatorhistory', ['status' => 'Updated'] + request()->query()) }}">Updated</a>
                </li>
                <li><a class="dropdown-item"
                        href="{{ route('AdminComponents.operatorhistory', ['status' => 'Deleted'] + request()->query()) }}">Deleted</a>
                </li>
                <li><a class="dropdown-item"
                        href="{{ route('AdminComponents.operatorhistory', ['status' => 'Restored'] + request()->query()) }}">Restored</a>
                </li>
            </ul>
        </div>
    </div>
