    ...
    <div class="dashboard-cards_box">
        ...
        <div class="dashboard-cards_item active-school-year">
            <a href="#" class="dashboard-cards-item_link">
                ...
                <div class="dashboard-cards-item_number-box">
                    <span class="dashboard-cards-item_year">
                        {{ $enrollment->strand->strand ?? 'STRAND' }}
                    </span>
                    <span class="dashboard-cards-item_text">
                        {{ $enrollment->strand->description ?? 'Description' }}
                    </span>
                </div>
            </a>
        </div>
        @else
        <div class="dashboard-cards_item active-school-year">
            <div class="dashboard-cards-item_link">
                <div class="dashboard-cards-item_bg_year"></div>
                <div class="dashboard-cards-item_title">
                    NOT ENROLLEE
                </div>
                <div class="dashboard-cards-item_number-box">
                    <span class="dashboard-cards-item_year">N/A</span>
                    <span class="dashboard-cards-item_text">Please enroll to see academic strand</span>
                </div>
            </div>
        </div>
        @endif
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <a class="btn btn-modal" href="{{ route('StudentComponents.setting') }}">Continue</a>
            </div>
        </div>
    </div>
</div>
