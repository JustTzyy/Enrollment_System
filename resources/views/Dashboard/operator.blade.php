...
<html lang="en">
    ...
    <head>
        ...
        <title>@yield('title', 'UMIANKonek | Operator Dashboard')</title>
        ...
        <link rel="stylesheet" href="{{ asset('/css/operatoradmin.css') }}">
    ...
    <body>
        ...
        {{-- NAVBAR --}}
        @include('OperatorLayouts.navbaroperator')

        <div class="d-flex">
            {{-- SIDEBAR --}}
            @include('OperatorLayouts.sidebaroperator')
