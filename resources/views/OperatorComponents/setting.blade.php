...
@section('operatorcontent')
    ...
    <div class="tab-content px-5" id="settingsTabsContent">
        ...
        <div class="tab-pane fade show active" id="user" role="tabpanel">
            <form class="row g-3" method="POST" action="{{ route('OperatorComponents.setting.updateUser') }}">
                @csrf
                <div class="col-md-4">
        ...
        <div class="tab-pane fade" id="address" role="tabpanel">
            <form class="row g-3" method="POST" action="{{ route('OperatorComponents.setting.updateAddress') }}">
                @csrf
                <div class="col-md-6">
