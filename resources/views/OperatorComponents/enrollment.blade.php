...
@section('operatorcontent')
  ...
  <div class="d-flex justify-content-between align-items-center mt-5 flex-wrap gap-3">
    ...
    <form action="{{ route('OperatorComponents.enrollment') }}" method="GET">
  ...
  <div class="table-responsive mt-3">
    ...
    <tbody>
      ...
      <form action="{{ route('OperatorComponents.enrollment.update', $enrollment->id) }}" method="POST">
      @csrf
  ...
  $(document).ready(function () {
    ...
    $(document).on('change', 'select[id^="strandID"], select[id^="gradeLevel"], select[id^="semester"]', function () {
      ...
      if (strandID && gradeLevel && semester) {
        $.ajax({
          url: "{{ route('OperatorComponents.get.sections.by.strand.and.grade') }}",
          type: "GET",
          data: {
            strand_id: strandID,
  ...
  <div class="modal fade" id="enrollModal" tabindex="-1" aria-labelledby="enrollModalLabel" aria-hidden="true">
    <div class="modal-dialog">
    <form action="{{ route('OperatorComponents.enrollment') }}" method="POST">
      @csrf
      <div class="modal-content">
      <div class="modal-header">
